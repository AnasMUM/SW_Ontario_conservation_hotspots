...
##Reactive
reactive.index<-overall.stress.scaled+res.fish.SAR.ratio
...
proactive.index.2<-(stress.inverse*2)+res.fish.SAR.ratio

proactive.index.2

proactive.index.3<-(stress.inverse*2)+res.fish.rich
...
#Representative
representative.index<-(res.fish.SAR.ratio)*2+(res.fish.rich)
